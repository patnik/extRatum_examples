...
- ratio of points in each class to the total LSOA area (or in other words the number of points by sqkm).
...
ow, we illustrate the use of `extRatum` with line data.
