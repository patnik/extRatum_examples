...
- the LSOA code;
- the total area in sqm of each LSOA;
- the number of points (i.e. shops) in each LSOA; and
- the ratio of points to the total LSOA area (or in other words the number of points by sqm). In this way, we have a relative measure that can be compared across all LSOAs and is independent of their size.
...
- the LSOA code;
- the total area in sqm of each LSOA;
- the area in sqm covered by the geospatial feature we have selected in each LSOA; and
- the ratio of geospatial feature area to the total LSOA area (or in other words the area covered by the geospatial feature by sqm).
...
- the LSOA code;
- the total area in sqm of each LSOA;
- the total line length in metres by the geospatial feature we have selected in each LSOA; and
- the ratio of geospatial feature length to the total LSOA area (or in other words the length of the geospatial feature by sqm). In this way, we have a relative measure that can be compared across all LSOAs and is independent of their size.
